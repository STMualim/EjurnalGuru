...
class EditJurnalView extends GetView<EditJurnalController> {
  const EditJurnalView({Key? key}) : super(key: key);
  @override
                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: GetBuilder<EditJurnalController>(
                                  builder: (context) {
                              ...
                              () => ElevatedButton(
                                ...
                                onPressed: () async {
                                  if (controller.isLoading.isFalse) {
                                    await controller.updateJurnalData();
                                  }
                                },
                                child: Text(
